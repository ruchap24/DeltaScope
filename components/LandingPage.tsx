    ...
    <div className="min-h-screen">
      ...
      <nav className="flex items-center justify-between px-12 py-4">
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/ruchap24/DeltaScope" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
          ...
          <Button className="bg-purple-600 hover:bg-purple-700 text-white" onClick={() => router.push('/deltascope')}>
            Get Started
          </Button>
        </div>
      </nav>
      ...
      <main className="relative px-6">
        <div className="text-center mb-8">
          ...
          >
            🔒 100% Private & Secure code Checking
          </Badge>
          ...
          <Button 
            ...
            onClick={() => router.push('/deltascope')}
          >
